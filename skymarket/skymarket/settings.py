...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get("POSTGRES_NAME", "skymarket_db"),
...
CORE_ORIGIN_WHITE_LIST = [
    'https://localhost',
]

CSRF_TRUSTED_ORIGINS = CORE_ORIGIN_WHITE_LIST
CORS_ALLOWED_ORIGINS = CORE_ORIGIN_WHITE_LIST
